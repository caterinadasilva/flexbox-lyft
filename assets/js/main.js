function validateForm() {
  var validNumber = /^56\b\d{3}[-.]?\d{3}[-.]?\d{4}\b/g;
  document.getElementById("driverBtn").addEventListener("click", function(){
    var testing = validNumber.test(driverNumber);
    var driverNumber = parseInt(document.getElementById('driverNumber').value);
    if (document.getElementById('driverNumber').value != "" || driverNumber.length > 9 ) {
